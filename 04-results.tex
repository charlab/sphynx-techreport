...
\jbs{This sentence needs work.}

\begin{figure}
\centering
\includegraphics[width=\columnwidth]{graphics/AreaEff.png}
\caption{Projected cache area and miss rate due to increased sharing \jbs{units omitted because the numbers are made up}}
\label{AreaEff}
\end{figure}
...
\caption{Simulated Miss and Stall Rates \jbs{what do the numbers mean?}}
...
\caption{Simulated miss and stall rates (zoomed-in) \jbs{what do the numbers mean?}}
